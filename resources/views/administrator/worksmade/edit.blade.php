...
@section('content_header')
    <div class="d-flex">
        <h1 class="mr-3">Editar obra</h1>
        <a href="{{ route('worksmade.content') }}" class="btn btn-sm btn-primary">ver obras</a>
    </div>
@stop
@section('content')
    <form action="{{ route('worksmade.update') }}" method="post" enctype="multipart/form-data" class="row">
        @csrf
