<div class="modal fade" id="modal-update-element">
    <form action="{{ route('video.update') }}" method="post" id="form-update-slider" class="modal-dialog">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                <input type="text" name="content_2" class="form-control" placeholder="Video">
            </div>    
        </div>
